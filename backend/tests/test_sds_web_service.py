...
from backend.application.services.sds_web_service import SDSWebSession, html_to_tsv, SDSWebAuthError, SDSWebError
...
def test_html_to_tsv_empty():
    ...
    raw_html = "<ekm-ajax-response><content><![CDATA[<div>No data</div>]]></content></ekm-ajax-response>"
