...
class TestMaintenanceServiceExtended(unittest.TestCase):
    ...
    def test_sync_and_check_all_with_discovery(self, mock_search):
        ...
        self.mock_repo.get_all_devices.return_value = [MaintenanceDevice(serial="S1", model_family="FamilyA", is_active=True)]
    ...
    def test_process_device_full_logic(self, mock_info, mock_meters):
        ...
        mock_meters.return_value = [{
            "meters": [{"name": "Ciclos de trabajo", "value": 5000}]
        }]
    ...
    def test_sync_single_device(self):
        self.mock_repo.get_all_devices.return_value = [MaintenanceDevice(serial="S1", model_family="F1", is_active=True)]
